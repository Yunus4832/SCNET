...
public class SubsystemDispenserBlockBehavior : SubsystemBlockBehavior
{
    ...
    {
        _subsystemBlockEntities.CreateBlockEntity("Dispenser", new Point3(x, y, z), miner);
    }
    ...
    public override bool OnInteract(TerrainRaycastResult raycastResult, ComponentMiner componentMiner)
    {
        ...
        var blockEntity = _subsystemBlockEntities.GetBlockEntity(raycastResult.CellFace.X,
        ...
        var componentDispenser = blockEntity.Entity.FindComponent<ComponentDispenser>(true)!;
        componentMiner.ComponentPlayer?.ComponentGui.ModalPanelWidget =
            new DispenserWidget(componentMiner.Inventory, componentDispenser);
    ...
    public override void OnHitByProjectile(CellFace cellFace, WorldItem worldItem)
    {
        ...
        if (blockEntity == null || !DispenserBlock.GetAcceptsDrops(
                Terrain.ExtractData(_subsystemTerrain.Terrain.GetCellValue(cellFace.X, cellFace.Y, cellFace.Z))))
        {
            return;
        }

        var inventory = blockEntity.Entity.FindComponent<ComponentDispenser>(true)!;
