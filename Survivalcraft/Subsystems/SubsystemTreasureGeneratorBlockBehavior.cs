...
{
    private static readonly TreasureData[] _treasureData;
    ...
    {
        var cellContents = SubsystemTerrain.Terrain.GetCellContents(neighborX, neighborY, neighborZ);
        ...
        var num = 0;
        var num2 = 0;
        var max = _treasureData.Sum(t => t.Probability);
        var num3 = _random.Float(0f, max);
        var treasureData = _treasureData;
        foreach (var treasureData2 in treasureData)
        {
            ...
            num2 = _random.Int(1, treasureData2.MaxCount);
            break;
        }
        ...
        {
            _subsystemPickables.AddPickable(num, 1,
                new Vector3(x, y, z) + _random.Vector3(0.1f, 0.4f) + new Vector3(0.5f), Vector3.Zero, null);
        }

        var num4 = _random.Int(3, 6);
        for (var k = 0; k < num4; k++)
        {
            _subsystemPickables.AddPickable(248, 1,
                new Vector3(x, y, z) + _random.Vector3(0.1f, 0.4f) + new Vector3(0.5f), Vector3.Zero, null);
        }
    }
