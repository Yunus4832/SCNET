...
{
    //服务器本身构造
    public Client(Guid guid, ProjectNet project)
    {
        GUID = guid;
        ProjectNet = project;
    ...
    /// <param name="projectNet">Project</param>
    ...
    private ProjectNet? ProjectNet { get; set; }
    ...
    public void SetProject(ProjectNet project)
    {
        ProjectNet = project;
        SubsystemPlayers = ProjectNet.FindSubsystem<SubsystemPlayers>(true)!;
    }
