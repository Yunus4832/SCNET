...
internal class WebTime
{
    ...
    public static DateTime GetWebTime()
    {
...
#if DEBUG
            Log.Information($"获取时间" + webTime.ToLocalTime().ToString("yyyy-MM-dd HH:mm:ss"));
#endif
        ...
        {
            DialogsManager.Confirm("网络检查不通过,请确保网络通畅再打开游戏!", btn => { Environment.Exit(0); });
