...
public class FurniturePackage : IPackage
{
    ...
    public void Handle(ProjectNet projectNet, NetNode netNode, bool isServer)
    {
        ...
        var furnitureInventoryPanel = projectNet.FindFurnitureInventorPanel(From);
        if (furnitureInventoryPanel == null)
        {
            return;
        }

        var subsystemTerrain = projectNet.FindSubsystem<SubsystemTerrain>();
        var subsystemFurnitureBlockBehavior = projectNet.FindSubsystem<SubsystemFurnitureBlockBehavior>(true)!;
        switch (_eventType)
        {
            case EventType.TryAddDesignChain:
            ...
            case EventType.RequestAdd:
                ...
                {
                    furniture = subsystemFurnitureBlockBehavior.CreateDesign(player.ComponentMiner, furniture, _pointDict,
