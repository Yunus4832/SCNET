...
public class ServerInfoPackage : IPackage
{
    ...
    public ServerInfoPackage(bool requestInfo)
    {
        ...
        _version = ProjectNet.ServerVersion;
        _clientCount = (ushort)CommonLib.Net.ClientCount;
        _maxPlayerCount = ProjectNet.SubsystemGameInfo.WorldSettings.MaxOnlinePlayerCount;
        _gameMode = ProjectNet.SubsystemGameInfo.WorldSettings.GameMode;
        _needLogin = ProjectNet.SubsystemGameInfo.WorldSettings.IsNeedCommunityLogin;
        _needPasswd = !string.IsNullOrEmpty(ProjectNet.SubsystemGameInfo.WorldSettings.Password);
        _timeOfDay = ProjectNet.SubsystemTimeOfDay.CalculateTimeOfDay();
        _modServerAddress = SettingsManager.ModServerAddress;
        _season = ProjectNet.SubsystemSeasons.Season;
        _timeOfSeason = ProjectNet.SubsystemSeasons.TimeOfSeason;
    }
