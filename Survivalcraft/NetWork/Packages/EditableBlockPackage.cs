...
public class EditableBlockPackage : IPackage
{
    ...
    {
        var subInventory = projectNet.FindSubsystem<SubsystemInventories>(true)!;
        switch (_itemType)
        {
            case EditableItemType.MemoryBank:
                var behavior = projectNet.FindSubsystem<SubsystemMemoryBankBlockBehavior>();
                if (behavior is null)
                {
                    return;
                }
            ...
            case EditableItemType.TruthTable:
                var truthBehavior = projectNet.FindSubsystem<SubsystemTruthTableCircuitBlockBehavior>(true)!;
            ...
            case EditableItemType.AdjustableDelayGate:
                ...
                {
                    var st = projectNet.FindSubsystem<SubsystemTerrain>(true)!;
