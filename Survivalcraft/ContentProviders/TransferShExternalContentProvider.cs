...
public class TransferShExternalContentProvider : IExternalContentProvider
{
    ...
    )
    {
        try
        {
            ...
            WebManager.Put(
                ...
                {
                    var obj2 = Encoding.UTF8.GetString(result, 0, result.Length).Trim();
                    success(obj2);
                },
                failure
            );
