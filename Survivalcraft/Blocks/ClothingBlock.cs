...
public class ClothingBlock : Block
{
    ...
    {
        Num = 0;
        var xElement = _initializationData;
    ...
    internal static void SetInitializationData(XElement data)
    {
        _initializationData = new XElement(data);
    }
            ...
            if (num != 0 && num3 != 0)
            {
                ...
                if (num4 != clothingColor)
                {
                    return new CraftingRecipe
                    {
                        ...
                        Description =
                            $"{LanguageManager.Get("BlocksManager", "Dyed")} {SubsystemPalette.GetName(color, string.Empty)}",
            ...
            if (num2 != 0 && num3 != 0)
            {
                ...
                if (clothingColor2 != 0)
                {
                    return new CraftingRecipe
                    {
                        ...
                        RequiredHeatLevel = 1f,
                        Description = LanguageManager.Get("BlocksManager", "Not Dyed") + " " +
                                      LanguageManager.Get("BlocksManager", "Clothes"),
                        Ingredients = (string[])ingredients.Clone()
                    };
                }
            }
