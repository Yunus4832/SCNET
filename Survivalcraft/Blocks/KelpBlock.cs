...
public class KelpBlock : WaterPlantBlock
{
    ...
    {
        return face < 0 ? 104 : base.GetFaceTextureSlot(face, value);
    }
    ...
    )
    {
        BlocksManager.DrawFlatOrImageExtrusionBlock(
            ...
            size,
            ref matrix, null,
            color * BlockColorsMap.KelpColorsMap.Lookup(environmentData.Temperature, environmentData.Humidity),
            false,
            environmentData
        );
    }
    ...
    {
        var color = BlockColorsMap.KelpColorsMap.Lookup(generator.Terrain, x, y, z);
    ...
    )
    {
        return new BlockDebrisParticleSystem(
            ...
            BlockColorsMap.KelpColorsMap.Lookup(
