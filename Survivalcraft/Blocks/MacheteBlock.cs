...
public abstract class MacheteBlock(int handleTextureSlot, int headTextureSlot) : Block
{
    ...
    {
        var model = ContentManager.Get<Model>("Models/Machete");
        var handlerMesh = model.FindMesh("Handle")!;
        var boneAbsoluteTransform = BlockMesh.GetBoneAbsoluteTransform(
            handlerMesh.ParentBone ??
        ...
        blockMesh.AppendModelMeshPart(handlerMesh.MeshParts[0],
