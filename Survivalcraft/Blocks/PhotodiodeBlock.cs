...
public class PhotodiodeBlock : MountedElectricElementBlock
{
    ...
    {
        var model = ContentManager.Get<Model>("Models/Photodiode");
        var photodiodeMesh = model.FindMesh("Photodiode")!;
        var boneAbsoluteTransform = BlockMesh.GetBoneAbsoluteTransform(
            photodiodeMesh.ParentBone ??
            throw new InvalidOperationException("Required PhotodiodeMesh.ParentBone is null")
        );
        for (var i = 0; i < 6; i++)
        {
            var num = i;
            ...
            BlockMeshesByData[num].AppendModelMeshPart(photodiodeMesh.MeshParts[0],
        ...
        StandaloneBlockMesh.AppendModelMeshPart(photodiodeMesh.MeshParts[0], boneAbsoluteTransform * m2,
