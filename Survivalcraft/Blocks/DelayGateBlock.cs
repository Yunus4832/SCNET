...
public class DelayGateBlock() : RotatableMountedElectricElementBlock("Models/Gates", "DelayGate", 0.375f)
{
    ...
    )
    {
        ...
        {
            ElectricConnectorDirection.Bottom => ElectricConnectorType.Input,
