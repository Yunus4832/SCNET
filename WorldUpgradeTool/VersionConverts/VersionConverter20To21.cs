...
public class VersionConverter20To21 : VersionConverter
{
    ...
    public override void ConvertProjectXml(XElement projectNode)
    {
                 ...
                 select e)
        {
            ...
            var array = item3.Elements().ToArray();
            foreach (var xElement4 in array)
            {
                xElement4.Remove();
                xElement3.Add(xElement4);
            }

            xElement3.Add(new XElement("Value", new XAttribute("Name", "CharacterSkinName"),
                new XAttribute("Type", "string"), new XAttribute("Value", value)));
            item3.Add(xElement2);
            item3.Add(new XElement("Value", new XAttribute("Name", "NextPlayerIndex"), new XAttribute("Type", "int"),
