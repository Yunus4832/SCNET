...
public struct Line2 : IEquatable<Line2>
{
    ...
    {
        var num = 0f - Vector2.Cross(l1.Normal, l2.Normal);
        if (num == 0f)
        {
            return null;
        }
        ...
        var num2 = 1f / num;
        return new Vector2((l2.Normal.Y * l1.D - l1.Normal.Y * l2.D) * num2,
            (l1.Normal.X * l2.D - l2.Normal.X * l1.D) * num2);
    }
