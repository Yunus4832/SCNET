...
[ApiController]
[Route("api/v1")]
public sealed class AdministratorApplicationController(
    IMediator mediator,
    ApiKeyAuthenticationContext authenticationContext) : ControllerBase
{
    [HttpPost("administrators/applications")]
    public async Task<ResponseData<AdministratorApplicationResponse>> Apply(ApplyAdministratorRequest request,
