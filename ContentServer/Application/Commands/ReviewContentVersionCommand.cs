...
public enum ReviewContentVersionResult { Completed, NotFound, InvalidState }
...
{
    public async Task<ReviewContentVersionResult> Handle(ReviewContentVersionCommand command, CancellationToken cancellationToken)
    {
        ...
        return content.ReviewVersion(
               ...
               ) ? ReviewContentVersionResult.Completed : ReviewContentVersionResult.InvalidState;
    }
}
